      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <br>
            ...
            <form class="form-horizontal"  action="/admin/user/{{$u->id}}/update" method="post">
                    {{ csrf_field() }}
              ...
              <div class="col-md-offset-3">
                ...
                <div class="form-group">
                  <b> Nama Lengkap</b>
                  <input type="text" name="nama" class="form-control" style="width: 50%" value="{{$u->name}}">
                </div>
                ...
                <div class="form-group">
                  <b> Username</b>
                  <input type="text" name="username" class="form-control" style="width: 50%" value="{{$u->username}}">
                </div>
